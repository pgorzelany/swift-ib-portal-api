...
//
//    public static var `default` = APIClient(baseURL: IBPortalApi.Server.main)
//
...
//        jsonEncoder.dateEncodingStrategy = .formatted(IBPortalApi.dateEncodingFormatter)
//    }
//
...
//            let response = APIResponse<T>(request: request, result: Result<APIResponseValue, APIClientError>.failure(error))
//            complete(response)
//            return nil
//        }
//
...
//                let response = APIResponse<T>(request: request, result: Result<APIResponseValue, APIClientError>.failure(error), urlRequest: urlRequest)
//                requestBehaviour.onFailure(error: error)
//                complete(response)
//            }
//        }
