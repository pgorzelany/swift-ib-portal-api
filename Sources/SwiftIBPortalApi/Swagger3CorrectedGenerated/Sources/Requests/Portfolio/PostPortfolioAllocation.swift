...
extension API.Portfolio {
    ...
    */
    public enum PostPortfolioAllocation {

        public static let service = APIService<Response>(id: "postPortfolioAllocation", tag: "Portfolio", method: "POST", path: "/portfolio/allocation", hasBody: true, securityRequirements: [])
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(body: Body, options: Options, encoder: RequestEncoder? = nil) {
                ...
                super.init(service: PostPortfolioAllocation.service) { defaultEncoder in
