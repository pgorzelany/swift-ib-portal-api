...
extension IBPortalApi.Portfolio {
    ...
    public enum PostPortfolioByAccountIdPositionsInvalidate {
        ...
        public static let service = APIService<Response>(id: "postPortfolioByAccountIdPositionsInvalidate", tag: "Portfolio", method: "POST", path: "/portfolio/{accountId}/positions/invalidate", hasBody: false, securityRequirements: [])
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(options: Options) {
                ...
                super.init(service: PostPortfolioByAccountIdPositionsInvalidate.service)
            }
