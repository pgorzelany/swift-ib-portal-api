    ...
    */
    public enum GetPortfolioByAccountIdPositionByConid {
        ...
        public enum Response: APIResponseValue, CustomStringConvertible, CustomDebugStringConvertible {
            public typealias SuccessType = Position

            /** returns a list containing only one position for the conid */
            case status200(Position)

            public var success: Position? {
                switch self {
            ...
            public init(statusCode: Int, data: Data, decoder: ResponseDecoder) throws {
                switch statusCode {
                case 200: self = try .status200(decoder.decode(Position.self, from: data))
